 ...
 */
  useEffect(() => {
    const fetchData = async () => {
      ...
      const { data: usuario } = await supabase
        ...
        .eq("id", user.id)
        .single();
      if (usuario) setDentistName(usuario.nombre);
  ...
  const firstName = dentistName.split(" ")[0];
    ...
    <div className="max-w-4xl flex flex-col gap-6">
      ...
      <div className="rounded-2xl bg-[#283A97] px-8 py-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="text-[#9FB3E8] text-sm mb-1">Panel del odontólogo</p>
          <h1 className="text-3xl font-semibold">Hola, {firstName}</h1>
          <p className="mt-1 text-[#C7D3F0] text-sm">Aquí tienes el resumen de tu actividad del día.</p>
        </div>
      </div>
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              },
              {
                ...
                description: "Buscar y gestionar pacientes",
